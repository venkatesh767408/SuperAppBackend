...
const OTP = require("./userotp.model");
...
const register = async (req, res) => {
  ...
  try {
    ...
    const otpDoc = new OTP({
      ...
      pendingData: {
        name,
        password, // raw password, NOT hashed
...
const verifyRegistration = async (req, res) => {
  ...
  try {
    ...
    const { name, password, globalRole } = otpDoc.pendingData;
...
await user.save();
    ...
    const token = jwt.sign(
      { id: user._id, globalRole: user.globalRole },
